...
def Ankh_initialize():
    # Descargará el modelo base de Ankh directamente desde Hugging Face
    ankh_model = T5ForConditionalGeneration.from_pretrained("ElnaggarLab/ankh-base", local_files_only=False)
    ankh_tokenizer = AutoTokenizer.from_pretrained("ElnaggarLab/ankh-base", local_files_only=False)
